...
//     Load layers of data
    map.setLayoutProperty('water_data', 'visibility', 'none');
    map.setLayoutProperty('landslide_data', 'visibility', 'none');
    map.setLayoutProperty('access_data', 'visibility', 'none');
    map.setLayoutProperty('floodzone_data', 'visibility', 'none');
    map.setLayoutProperty('slope_data', 'visibility', 'none');
 ...
 map.on('idle', () => {
    ...
    const land = ['landslide']
     ...
     const property_types = {
        'water_data' : 'objectid',
        'landslide_data' : 'gridcode',
        'access_data': 'k_complexity',
        'informal_data': 'gridcode',
        'floodzone_data' : 'gridcode',
        'slope_data' : 'gridcode',
     };
...
//      }
     ...
     $(document).ready(function(){
         ...
         $('input[type="checkbox"]').click(function(){
             let name = this.getAttribute("k_complexity");
             let group = layer_mapping[name];
             let none = []
